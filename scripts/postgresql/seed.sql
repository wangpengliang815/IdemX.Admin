...
-- 角色编码与 AuthConstants.AdminRoleCode 一致
...
INSERT INTO public.sys_menu (
    ...
    (1800000000000000004, NULL, 'system', '/system', NULL, '后台管理', 'mdi:cog', 999,
    ...
    (1800000000000000008, 1800000000000000004, 'system_org', '/system/org', '/system/org/index', '组织管理', 'mdi:sitemap', 4,
        FALSE, FALSE, TRUE, 0, 1, CURRENT_TIMESTAMP, FALSE),
    (1800000000000000009, 1800000000000000004, 'system_record', '/system/record', NULL, '日志管理', 'mdi:clipboard-text-outline', 5,
        FALSE, FALSE, TRUE, 0, 1, CURRENT_TIMESTAMP, FALSE),
