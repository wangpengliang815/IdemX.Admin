...
/** 按角色编码获取可见菜单树 */
export function getMenusApi(roleCode: 'admin' | 'buyer' | 'cp'): Promise<ApiResponse<SysMenuResp[]>> {
...
/** 申请开通合约伙伴角色 */
export function convertToContractPartnerApi(): Promise<ApiResponse<void>> {
  return requestClient.post('/userProfile/convertToContractPartner');
}
